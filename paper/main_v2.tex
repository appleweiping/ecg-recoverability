...
% ---- result macros (generated from results/*.json by scripts/paper_numbers.py) ----
...
\section{Experiments}
\label{sec:exp}
% \input{results_v2_maps}     % per-lead eta/kappa map + rcond sensitivity + CI (Fig)
% \input{results_v2_calib}    % Tier-II coverage table
% \input{results_v2_baseline} % baselines + physics-vs-PCA + ST-safety certificate
\emph{[Results sections wired from results/recoverability\_maps.json,
tier2\_conformal.json, baselines\_physics.json, st\_safety.json.]}
