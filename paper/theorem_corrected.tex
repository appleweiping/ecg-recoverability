% Corrected mathematical core (P0-1). Drop-in replacement for the old Theorem 1;
% to be wired into main.tex during the paper rewrite. No claim of residual
% independence on real data; per-target-lead identifiability + conditioning; the
% strict independence/Var(u) lower bound is stated only for the synthetic model.

\newtheorem{theoremc}{Theorem}
\newtheorem{propc}{Proposition}

% ---------------------------------------------------------------- setup
\paragraph{Model.} Within segment $s$ write the population 12-lead vector as
...
% ---------------------------------------------------------------- residual (honest)
\paragraph{The non-dipolar residual (no independence claim on real data).}
