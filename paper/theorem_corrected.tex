...
leads at any SNR, independent of $\varrho$. This exactness is conditional on the a-priori rank-3
dipole model for $\bm M_s$: at retained rank~2 the limb-6 observation spans all of $\bm M_s$ and
the precordial verdict collapses to $\eta{=}0$; the non-identifiability appears at rank~$\ge$3
(the third dipolar direction), so ``exact'' means exact \emph{given} rank~3.
