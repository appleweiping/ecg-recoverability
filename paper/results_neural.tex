...
\begin{figure}[t]
  ...
  perception-optimal. As the perceptual weight grows, certified hallucination energy
  rises and correlation with truth falls: fabrication is chosen by the objective.}
  \label{fig:pd}
\end{figure}
