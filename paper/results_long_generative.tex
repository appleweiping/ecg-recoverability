...
$1.95\!\to\!2.35$; a small dip at $w{=}2$ then a clear rise, so worsening but not monotone) and
the amplitude-Wasserstein distance rises (V2: $0.29\!\to\!0.67$). The trend is toward worse
realism on most axes (a few, e.g.\ V4 amplitude, are flat); there is no monotone
...
(QRS/ST) and $0.21$--$0.34$ for V4/V6---consistent with the calibrated Tier-II intervals of
