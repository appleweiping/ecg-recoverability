...
multi-seed re-analysis reduced to an effect whose seed-level 95\% CI includes zero, with no
supporting realism trend. This long version accompanies a four-page conference paper and contains the full
